/*Starfish is a concrete subclass of the abstract class Item, with name and price as given in the constructor and
...
public class Starfish extends Item {
    ...
    public String getDescription(){
        return "20cm across, blue and pink with white bobbles";
    }
