/*Whale is a concrete subclass of the abstract class Item, with name and price as given in the constructor and
 * stock as shown below.*/
public class Whale extends Item {

    private static int stock = 3;

    public Whale(){super("Whale", 1299);}

    /*Implements the getDescription method from Item. */
    public String getDescription(){
            return "50cm long and perfect for cuddling";
        }
